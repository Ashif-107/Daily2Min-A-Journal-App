    ...
    async function fetchJournals() {
      try {
        ...
        if (Array.isArray(data)) {
          // Sort journals by createdAt in descending order
          const sortedJournals = data.sort((a: Journal, b: Journal) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
